...
const createCards = (character) => {
    ...
    // Agregando la lista a la clase card-character
    ...
    genderCharacter.textContent = "Especie: " + character.species; //species
...
const getCharacterByName = async (event) => {
    ...
    const data = awair = await getApi(URL2 + event.target.value);
